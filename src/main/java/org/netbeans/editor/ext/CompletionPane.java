...
/**
 * Pane displaying the completion view and accompanying components like label for title etc. It can
 * be a scroll-pane with the label at the top or something else.
 * 
