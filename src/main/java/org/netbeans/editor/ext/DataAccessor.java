...
public interface DataAccessor {
   ...
   * 
   * @param requestWrite
   *          if true, file is opened for read/write operation.
   */
  ...
  /**
   * Appends exactly <code>len</code> bytes, starting at <code>off</code> of the buffer pointer to
   * the end of file resource.
   * 
   * @param buffer
   *          the buffer from which the data is appended.
   * @param off
