...
public class ExtSettingsDefaults extends SettingsDefaults {
  ...
  public static final MultiKeyBinding[] defaultExtKeyBindings = new MultiKeyBinding[]{
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_F, InputEvent.CTRL_MASK),
          ExtKit.findAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_FIND, 0), ExtKit.findAction),
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_SPACE, InputEvent.CTRL_MASK + InputEvent.SHIFT_MASK),
              ExtKit.completionShowAction),
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_OPEN_BRACKET, InputEvent.CTRL_MASK |
          InputEvent.SHIFT_MASK), ExtKit.selectionMatchBraceAction),
