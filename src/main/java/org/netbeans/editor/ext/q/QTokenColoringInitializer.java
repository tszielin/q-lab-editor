...
//  Font biFont = SettingsDefaults.defaultFont.deriveFont(Font.ITALIC + Font.BOLD);
  ...
  Settings.Evaluator lightGraySubst = new SettingsUtil.ForeColorPrintColoringEvaluator(
      Color.lightGray);
  ...
  private Coloring USER_COMMENT_Coloring;
  ...
  private Coloring buildColoring(String name, Font font, Color defaultColor) {
    ...
    return new Coloring(font, Coloring.FONT_MODE_APPLY_STYLE, 
        config != null ? config.getTokenColor(name, defaultColor) : defaultColor, null);
  }

  public QTokenColoringInitializer() {
    super(QTokenContext.context);
    CHARVECTOR_Coloring = buildColoring("CHARVECTOR", SettingsDefaults.defaultFont, new Color(0,
        200, 20));
    EOL_COMMENT_Coloring = buildColoring("EOLCOMMENT", italicFont, Color.GRAY);
    USER_COMMENT_Coloring = buildColoring("USERCOMMENT", boldFont, Color.RED);
    IDENTIFIER_Coloring = buildColoring("IDENTIFIER", SettingsDefaults.defaultFont, new Color(180,
        160, 0));
    OPERATOR_Coloring = buildColoring("OPERATOR", SettingsDefaults.defaultFont, Color.BLACK);
    BOOLEAN_Coloring = buildColoring("BOOLEAN", SettingsDefaults.defaultFont, new Color(51, 204,
        255));
    ...
    INTEGER_Coloring = buildColoring("INTEGER", SettingsDefaults.defaultFont, new Color(51, 104,
        255));
    FLOAT_Coloring = buildColoring("FLOAT", SettingsDefaults.defaultFont, new Color(51, 104, 255));
    TIMESTAMP_Coloring = buildColoring("TIMESTAMP", SettingsDefaults.defaultFont, new Color(184,
        138, 0));
    TIMESPAN_Coloring = buildColoring("TIMESPAN", SettingsDefaults.defaultFont, new Color(184, 138,
        0));
    DATETIME_Coloring = buildColoring("DATETIME", SettingsDefaults.defaultFont, new Color(184, 138,
        0));
  ...
  public Object getTokenColoring(TokenContextPath tokenContextPath,
    ...
    if (!printingSet) {
      switch (tokenIDOrCategory.getNumericID()) {
        ...
        case QTokenContext.USER_COMMENT_ID:
          return USER_COMMENT_Coloring;
        default:
