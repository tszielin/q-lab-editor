...
public class QTokenContext extends TokenContext {
  private QTokenContext() {
    ...
    try {
      ...
      Logger.getLogger("QTokenContext").log(Level.SEVERE, "Unexpected exception", ex);
    }
  }
  ...
  public static final int USER_COMMENT_ID = 32;
  ...
  public static final BaseTokenID USER_COMMENT = new BaseTokenID("userComment", USER_COMMENT_ID);
  public static final BaseTokenID KEYWORD = new BaseTokenID("keyword", KEYWORD_ID);
