...
/**
 * All the strings that should be localized will go through this place. Multiple custom localizers
 * can be registered. The strings already retrieved are cached for the faster performance.
 * 
...
public class LocaleSupport {
  ...
  private static final Map<String, String> cache = new HashMap<String, String>(503);

  private static Localizer[] localizers = new Localizer[0];

  /**
   * Add a new localizer to the localizer array. The array of localizers is tracked from the lastly
   * added localizer to the firstly added one until the translation for the given key is found.
   * 
   * @param localizer
   ...
   *          key to translate to localized string.
   * @param defaultValue
   *          default value to be returned in case no localized string is found for the given key.
   */
   ...
   * This method is mainly usable for getting localized mnemonics.
   * 
   * @param key
   *          key to translate to localized character.
   * @param defaultValue
   *          default value to be returned in case no localized character is found for the given
   *          key.
   */
  ...
  /**
   * Translates the keys to the localized strings. There can be multiple localizers registered in
   * the locale support.
   */
