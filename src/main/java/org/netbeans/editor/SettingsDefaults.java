...
/**
 * Default values for the settings. They are used by <tt>BaseSettingsInitializer</tt> to initialize
 * the settings with the default values. They can be also used for substitution if the value of the
...
public class SettingsDefaults {
  ...
  // Default coloring
  private static int defaultFontSize = 12; // =24; // Fix of #33249
  public static Font defaultFont;
  public static Integer defaultTextLimitWidth;
  
  static {
    // Font systemDefaultFont = Config.getInstance().getFont();
    try {
      AppConfig config = AppConfig.getConfig();
      defaultFont = config.getFont();
      defaultFontSize = config.getFont().getSize();
      defaultTextLimitWidth = config.isMargin() ? config.getMargin() : 0;
    }
    catch (StudioException ignored) {
      defaultFontSize = 12;
      defaultFont = new Font("Monospaced", Font.PLAIN, defaultFontSize);
      defaultTextLimitWidth = new Integer(80);
    }
  }

  // public static Font defaultFont = new Font( "Monospaced", Font.PLAIN, defaultFontSize); //
  // NOI18N
  // public static Font defaultFont = new Font( "Monospaced", Font.PLAIN, defaultFontSize); //
  // NOI18N
  ...
  public static final void init() {
    try {
      defaultBackColor = AppConfig.getConfig().getTokenColor("BACKGROUND");
    }
    catch (StudioException ignored) {
  ...
  public static final Coloring defaultLineNumberColoring = new Coloring(null,
      defaultLineNumberForeColor, defaultLineNumberBackColor);
  ...
  public static final Coloring defaultSelectionColoring = new Coloring(null,
      defaultSelectionForeColor, defaultSelectionBackColor);
  ...
  public static final Coloring defaultHighlightSearchColoring = new Coloring(null,
      defaultHighlightSearchForeColor, defaultHighlightSearchBackColor);
  ...
  public static final Coloring defaultIncSearchColoring = new Coloring(null,
      defaultIncSearchForeColor, defaultIncSearchBackColor);
  /*
   * // Bookmark coloring public static final Color defaultBookmarkForeColor = Color.black; public
   * static final Color defaultBookmarkBackColor = new Color(184, 230, 230); public static final
   * Coloring defaultBookmarkColoring = new Coloring(null, defaultBookmarkForeColor,
  ...
  public static final Coloring defaultStatusBarColoring = new Coloring(null,
      defaultStatusBarForeColor, defaultStatusBarBackColor);
  ...
  public static final Coloring defaultStatusBarBoldColoring = new Coloring(null,
      defaultStatusBarBoldForeColor, defaultStatusBarBoldBackColor);
  ...
  public static final Integer defaultSyntaxUpdateBatchSize = new Integer(
      defaultMarkDistance.intValue() * 7);
  ...
  public static final String[] defaultColoringNames = new String[]{SettingsNames.DEFAULT_COLORING,
      SettingsNames.LINE_NUMBER_COLORING, SettingsNames.GUARDED_COLORING,
      SettingsNames.SELECTION_COLORING, SettingsNames.HIGHLIGHT_SEARCH_COLORING,
      SettingsNames.INC_SEARCH_COLORING,
      // SettingsNames.BOOKMARK_COLORING,
      SettingsNames.STATUS_BAR_COLORING, SettingsNames.STATUS_BAR_BOLD_COLORING};
  ...
  public static final MultiKeyBinding[] defaultKeyBindings = new MultiKeyBinding[]{
      new MultiKeyBinding((KeyStroke)null, // this assigns the default action to keymap
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_BACK_SPACE, 0),
       ...
       * InputEvent.SHIFT_MASK), BaseKit.deletePrevCharAction ),
       */new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_DELETE, 0),
          BaseKit.deleteNextCharAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT, 0), BaseKit.forwardAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_KP_RIGHT, 0), // keypad right
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT, menuShortcutKeyMask),
          BaseKit.nextWordAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT, InputEvent.SHIFT_MASK |
          menuShortcutKeyMask), BaseKit.selectionNextWordAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, 0), BaseKit.backwardAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_KP_LEFT, 0), // keypad left
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, menuShortcutKeyMask),
          BaseKit.previousWordAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, InputEvent.SHIFT_MASK |
          menuShortcutKeyMask), BaseKit.selectionPreviousWordAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, 0), BaseKit.downAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_KP_DOWN, 0), // keypad down
          BaseKit.downAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, InputEvent.SHIFT_MASK),
          BaseKit.selectionDownAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, menuShortcutKeyMask),
          BaseKit.scrollUpAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_UP, 0), BaseKit.upAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_KP_UP, 0), // keypad up
          BaseKit.upAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_UP, InputEvent.SHIFT_MASK),
          BaseKit.selectionUpAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_UP, menuShortcutKeyMask),
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_HOME, menuShortcutKeyMask),
          BaseKit.beginAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_HOME, InputEvent.SHIFT_MASK |
          menuShortcutKeyMask), BaseKit.selectionBeginAction),
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_END, menuShortcutKeyMask),
          BaseKit.endAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_END, InputEvent.SHIFT_MASK |
          menuShortcutKeyMask), BaseKit.selectionEndAction),

      // clipboard bindings
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_C, menuShortcutKeyMask),
          BaseKit.copyAction),
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_DELETE, InputEvent.SHIFT_MASK),
          BaseKit.cutAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_X, menuShortcutKeyMask),
          BaseKit.cutAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_CUT, 0), BaseKit.cutAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_V, menuShortcutKeyMask),
          BaseKit.pasteAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_INSERT, InputEvent.SHIFT_MASK),
          BaseKit.pasteAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_PASTE, 0), BaseKit.pasteAction),

      // undo and redo bindings - handled at system level
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_Z, menuShortcutKeyMask),
          BaseKit.undoAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_UNDO, 0), BaseKit.undoAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_Y, menuShortcutKeyMask),
          BaseKit.redoAction),

      // other bindings
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_A, menuShortcutKeyMask),
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_W, menuShortcutKeyMask),
          BaseKit.removeWordAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_U, menuShortcutKeyMask),
       ...
       */
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_INSERT, 0),
          BaseKit.toggleTypingModeAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_F2, menuShortcutKeyMask),
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_F3, menuShortcutKeyMask),
          BaseKit.findSelectionAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_H, InputEvent.ALT_MASK |
          InputEvent.SHIFT_MASK), BaseKit.toggleHighlightSearchAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_L, menuShortcutKeyMask),
          BaseKit.wordMatchNextAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_K, menuShortcutKeyMask),
          BaseKit.wordMatchPrevAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_T, menuShortcutKeyMask),
          BaseKit.shiftLineRightAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_D, menuShortcutKeyMask),
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_C, menuShortcutKeyMask |
          InputEvent.SHIFT_MASK), BaseKit.annotationsCyclingAction),
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_T, InputEvent.SHIFT_MASK |
          InputEvent.ALT_MASK), BaseKit.adjustCaretTopAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_M, InputEvent.SHIFT_MASK |
          InputEvent.ALT_MASK), BaseKit.adjustCaretCenterAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_B, InputEvent.SHIFT_MASK |
          InputEvent.ALT_MASK), BaseKit.adjustCaretBottomAction),

      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_F, menuShortcutKeyMask |
          InputEvent.SHIFT_MASK), BaseKit.formatAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_J, InputEvent.ALT_MASK),
          BaseKit.selectIdentifierAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_K, InputEvent.ALT_MASK),
          BaseKit.jumpListPrevAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_L, InputEvent.ALT_MASK),
          BaseKit.jumpListNextAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_K, InputEvent.SHIFT_MASK |
          InputEvent.ALT_MASK), BaseKit.jumpListPrevComponentAction),
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_L, InputEvent.SHIFT_MASK |
          InputEvent.ALT_MASK), BaseKit.jumpListNextComponentAction),
      new MultiKeyBinding(new KeyStroke[]{
          KeyStroke.getKeyStroke(KeyEvent.VK_U, InputEvent.ALT_MASK),
      ...
      new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_M, menuShortcutKeyMask),
