 ...
 * Developer of the Original Code is Sun Microsystems, Inc. Portions Copyright 1997-2002 Sun
...
/**
 * This class represents an abstract subclass for services (compilation, execution, debugging, etc.)
...
public abstract class ServiceType extends Object implements java.io.Serializable, HelpCtx.Provider {
  ...
  /**
   * Default human-presentable name of the service type. In the default implementation, taken from
   * the bean descriptor.
   * 
  ...
  /**
   * Method that creates a cloned instance of this object. Subclasses are encouraged to implement
   * the {@link Cloneable} interface, in such case the <code>clone</code> method is called as a
   * result of calling this method. If the subclass does not implement <code>Cloneable</code>, it is
   * serialized and deserialized, thus new instance created.
   * 
   * @return new instance
   * @exception IllegalStateException
   *              if something goes wrong, but should not happen
  ...
  /**
   * Correctly implements the clone operation on this object. In order to work really correctly, the
   * subclass has to implement the Cloneable interface.
   * 
  ...
  /**
   * Set the name of the service type. Usually it suffices to override {@link #displayName}, or just
   * to provide a {@link BeanDescriptor} for the class.
   * 
   * @param name
  ...
  /**
   * Get the name of the service type. The default value is given by {@link #displayName}.
   * 
  ...
  /**
   * The registry of all services. This class is provided by the implementation of the IDE and
   * should hold all of the services registered to the system.
   * <P>
  ...
  public static abstract class Registry implements java.io.Serializable {
     ...
     */
    public Enumeration<?> services(final Class<?> cls) {
    ...
    /**
     * Setter for list of service types. This permits changing instances of the objects but only
     * within the types that are already registered in the system by manifest sections. If an
     * instance of any other type is in the list it is ignored.
     * 
     * @param arr
     *          a list of {@link ServiceType}s
     * @deprecated Better to change service instance files instead.
     */
    public abstract void setServiceTypes(java.util.List<?> arr);

    /**
     * Find the service type implemented as a given class. The whole registry is searched for a
     * service type of that exact class (subclasses do not count).
     * <P>
     * This could be used during (de-)serialization of a service type: only store its class name and
     * then try to find the type implemented by that class later.
     * 
     * @param cls
     ...
     * <P>
     * This could be used during (de-)serialization of a service type: only store its name and then
     * try to find the type later.
     * 
     * @param name
  ...
  /**
   * Handle for a service type. This is a serializable class that should be used to store types and
   * to recreate them after deserialization.
   */
  public static final class Handle extends Object implements java.io.Serializable {
    ...
    public ServiceType getServiceType() {
      if (serviceType == null) {
        ...
        try {
          cls = Class.forName(className, true, (ClassLoader)Lookup.getDefault().lookup(
              ClassLoader.class));

          serviceTypeClass = cls;
        ...
        ServiceType.Registry r = (ServiceType.Registry)Lookup.getDefault().lookup(
            ServiceType.Registry.class);
        Enumeration<?> en = r.services(cls);
        ServiceType some = r.find(cls);
        while (en.hasMoreElements()) {
          ...
          if (some == null || (some.getClass() != cls && t.getClass() == cls)) {
