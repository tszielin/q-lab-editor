...
public abstract class FolderInstance extends Task implements InstanceCookie {
    ...
    private HashMap<Object,Object> map = new HashMap<Object,Object> (17);
...
//        err.log ("instanceCreate: " + object);
    ...
    */
    final void processObjects (final Collection<Object> arr) {
    ...
    */
    ...
    private void updateWaitFor (HoldInstance[] arr) {
        List<Task> out = new ArrayList<Task>(arr.length);
        for (int i = 0; i < arr.length; i++) {
