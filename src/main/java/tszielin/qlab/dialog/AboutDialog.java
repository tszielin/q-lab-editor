...
//        JPanel pnlIcons = new JPanel(new BorderLayout());
//        pnlIcons.setBackground(color);
//        JPanel pnlItem = new JPanel(new FlowLayout(FlowLayout.CENTER, 10, 10));
//        pnlItem.setBackground(color);
//        JLabel label = new JLabel(new ImageIcon(IconsItem.IMAGE_KX));
//        label.setToolTipText("KX Systems");
...
//            }
//            catch (Exception ex) {
//              JOptionPane.showMessageDialog(getOwner(), "Error attempting to launch web browser:\n" +
//                  ex.getMessage(), "About", JOptionPane.ERROR_MESSAGE);
//            }      
//          }
//        });
//        pnlItem.add(label);
//        pnlIcons.add(pnlItem, BorderLayout.CENTER);

//        pnlItem = new JPanel(new FlowLayout(FlowLayout.CENTER, 10, 10));
//        pnlItem.setBackground(color);
//        label = new JLabel(new ImageIcon(IconsItem.IMAGE_SYMAGON));
//        label.setToolTipText("Symagon");
//        label.addMouseListener(new MouseListener() {      
//          public void mouseReleased(MouseEvent event) {
//          }      
//          public void mousePressed(MouseEvent event) {
...
//        });
//        pnlItem.add(label);
//        pnlInfo.add(pnlIcons, BorderLayout.WEST);
//        pnlIcons.add(pnlItem, BorderLayout.CENTER);
//        
//        pnlItem = new JPanel(new FlowLayout(FlowLayout.CENTER, 10, 10));
//        pnlItem.setBackground(color);
//        label = new JLabel(new ImageIcon(IconsItem.IMAGE_NC));
//        label.setToolTipText("Nagler & Company");
//        label.addMouseListener(new MouseListener() {      
//          public void mouseReleased(MouseEvent event) {
//          }      
//          public void mousePressed(MouseEvent event) {
...
//            try {
//              if (Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) { 
//                Desktop.getDesktop().browse(new URI("http://www.nagler-company.com"));
//              }
//            }
//            catch (Exception ex) {
//              JOptionPane.showMessageDialog(getOwner(), "Error attempting to launch web browser:\n" +
...
//        pnlItem.add(label);
//        pnlInfo.add(pnlIcons, BorderLayout.WEST);
//        pnlIcons.add(pnlItem, BorderLayout.SOUTH);
