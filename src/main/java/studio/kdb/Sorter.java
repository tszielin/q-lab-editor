...
public class Sorter {
  static public void sort(boolean a[], int lo, int hi, int permutation[], int scratch[]) {
    if (lo >= hi)
      return;
    ...
    for (k = lo; k <= hi; k++)
      if ((t_lo <= mid) &&
          ((t_hi > hi) || ((a[permutation[t_lo]] ? 1 : 0) <= (a[permutation[t_hi]] ? 1 : 0))))
  ...
  static public void sort(String a[], int lo, int hi, int permutation[], int scratch[]) {
    if (lo >= hi)
      return;
  ...
  static public void sort(char a[], int lo, int hi, int permutation[], int scratch[]) {
    if (lo >= hi)
      return;
  ...
  static public void sort(byte a[], int lo, int hi, int permutation[], int scratch[]) {
    if (lo >= hi)
      return;
  ...
  static public void sort(short a[], int lo, int hi, int permutation[], int scratch[]) {
    if (lo >= hi)
      return;
  ...
  static public void sort(long a[], int lo, int hi, int permutation[], int scratch[]) {
    if (lo >= hi)
      return;
  ...
  static public void sort(float a[], int lo, int hi, int permutation[], int scratch[]) {
    if (lo >= hi)
      return;
    ...
    for (k = lo; k <= hi; k++)
      if ((t_lo <= mid) &&
          ((t_hi > hi) || (Float.isNaN(a[permutation[t_lo]])) || (a[permutation[t_lo]] <= a[permutation[t_hi]])))
        scratch[k] = permutation[t_lo++];
      else
        scratch[k] = permutation[t_hi++];
  ...
  static public void sort(double a[], int lo, int hi, int permutation[], int scratch[]) {
    if (lo >= hi)
      return;
    ...
    for (k = lo; k <= hi; k++)
      if ((t_lo <= mid) &&
          ((t_hi > hi) || (Double.isNaN(a[permutation[t_lo]])) || (a[permutation[t_lo]] <= a[permutation[t_hi]])))
        scratch[k] = permutation[t_lo++];
      else
        scratch[k] = permutation[t_hi++];
  ...
  static public void sort(int a[], int lo, int hi, int permutation[], int scratch[]) {
    if (lo >= hi)
      return;
